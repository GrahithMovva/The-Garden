...
@Component
public class RequestFileDAO implements RequestDAO {
    Map<Integer,Plant> plants;
    private ObjectMapper objectMapper;
    private static int nextId;
    private String filename;

    public RequestFileDAO(@Value("${requests.file}") String filename, ObjectMapper objectMapper) throws IOException{
